...
from d_kmeans import KMeans, KMeansClassifier, get_k_means_plus_plus_center_indices as k_plus, get_lloyd_k_means as k_vanilla, transform_image
...
def kmeans_image_compression():
    ...
    centroids, _, i = k_means.fit(x=data)
